...
from scripts.e8_profile import measure_phase  # noqa: E402
...
def main() -> int:
    ...
    with measure_phase("offline-source-shim-validation"):
        validate_source_shim()
        if not SHIM_PATH.is_file():
            raise RuntimeError("Vendored shim is missing")
    with measure_phase("offline-cold-cache-purge"):
    ...
    with measure_phase("offline-strict-mkdocs"):
        try:
    ...
    with measure_phase("offline-generated-site-validation"):
