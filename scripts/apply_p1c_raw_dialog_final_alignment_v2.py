...
""",
        ...
        self.file_status_icon = QLabel()
""",
        "file size value block",
        flags=re.DOTALL,
    )

    text = sub_once(
        text,
        r"""        self\.expected_file_size_label = QLabel\("Expected"\)
...
""",
        "file size label definitions",
    )

    text = sub_once(
        text,
        r"""        self\.load_button = QPushButton\("Load JSON…"\)
...
""",
    ...
    text = sub_once(
        text,
        r"""        self\.button_grid = QGridLayout\(\)
...
""",
    ...
    text = sub_once(
        text,
        r"""        layout_form\.addRow\("Width", self\.width_box\)
...
""",
    ...
    text = sub_once(
        text,
        r"""        gray_levels_form\.addRow\("Black level", self\.black_gray\)
""",
...
""",
    ...
    text = sub_once(
        text,
        r"""        bayer_levels_form\.addRow\("Black level R", self\.black_r\)
...
""",
    ...
    text = sub_once(
        text,
        r"""        white_level_form = QFormLayout\(\)
