...
real external GPU server and SMB environment are available:
[`../deferred/p5g-external-gpu-smb-validation.md`](../deferred/p5g-external-gpu-smb-validation.md).

Do not infer P5-G PASS, activate P6, or implement production integration from this
pointer. Start a new active execution plan only when its prerequisites and authority
are available.
