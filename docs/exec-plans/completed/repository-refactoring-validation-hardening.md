...
- 2026-08-24: independent R7 review reproduced the full final gate on
  `9b9713cdb94375e583c98a1b775d70e5feb62138`: 933 passed with the same one Windows
  symlink-privilege skip, docs/Ruff/format/mypy/pip/diff PASS. One P1 stale R6 status
...
R0–R7 delivered explicit application/Remote-IQA composition, injected worker/resource
