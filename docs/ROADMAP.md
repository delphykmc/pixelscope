...
(F1 plus existing Help-error regression coverage) is in an independent implementation
PR; **E8 screenshot-rendering test performance** follows E7 completion and is tracked
