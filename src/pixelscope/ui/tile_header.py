...
class TileHeader(QWidget):
    ...
    def __init__(self, parent: QWidget | None = None) -> None:
        ...
        self.focus.setIcon(toolbar_icon("flag"))
        self.focus.setIconSize(QSize(TOKENS.icon_size, TOKENS.icon_size))
        self.focus.setCheckable(True)
        self.focus.setToolTip("Set as primary image")
        self.focus.setStatusTip("Set as primary image and move it to the first tile")
    ...
    def set_focus(self, focused: bool) -> None:
        ...
        self.focus.setToolTip("Primary image" if focused else "Set as primary image")
