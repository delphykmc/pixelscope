...
class DifferenceCurationLifecycle:
    """Apply the owner-final Keep/Calculate/toolbar contract around existing Diff owners."""
...
def install_difference_curation_lifecycle(window: Any, review_controller: Any) -> None:
